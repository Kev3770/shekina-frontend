                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-7 h-7 bg-white rounded-full flex items-center justify-center hover:bg-primary-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        {cart.length > 0 && (
          <div className="border-t border-primary-100 p-6 bg-white space-y-4">
            ...
            <button
              ...
              className="w-full btn-primary flex items-center justify-center gap-2 text-base py-4 hover:shadow-lg transition-shadow"
